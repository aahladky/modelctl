---
description: C++/SYCL work in the llama.cpp fork submodule (../llama.cpp) — MoE cache runtime, backend API, capability probe, fork builds and runtime tests.
mode: subagent
permission:
  bash:
    "*": ask
...
- Correctness is mandatory over speed: forced-hit, forced-miss, and mixed paths must match cache-disabled output.
